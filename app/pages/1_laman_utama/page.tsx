...
export default function LamanUtamaPage() {
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-100 w-full gap-4 text-center select-none p-6 bg-surface border border-border rounded-xl shadow-sm">
