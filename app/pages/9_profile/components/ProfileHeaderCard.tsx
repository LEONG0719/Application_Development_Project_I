...
export default function ProfileHeaderCard({
  ...
  return (
    <section className="mb-4 overflow-hidden rounded-[5px] border border-border bg-surface shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
      <div className="h-21.5 bg-gradient-to-r from-dark-blue to-brand-secondary" />
      <div className="relative flex min-h-20.25 items-center justify-between px-5.5 pl-32.25 max-sm:flex-col max-sm:items-start max-sm:gap-4 max-sm:px-4.5 max-sm:pb-5 max-sm:pt-17.5">
        <div className="absolute left-5.5 -top-8 h-23 w-23 rounded-lg bg-surface p-1.25 shadow-[0_4px_10px_rgba(15,23,42,0.13)] max-sm:left-4.5">
          <div
