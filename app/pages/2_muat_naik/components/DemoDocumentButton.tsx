...
export default function DemoDocumentButton({
  ...
  return (
    <button
      type="button"
      className="inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-border bg-surface px-5 text-xs font-bold text-dark-blue shadow-sm transition hover:border-border hover:bg-surface-muted disabled:cursor-not-allowed disabled:opacity-50"
